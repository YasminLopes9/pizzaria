// Rotas da API
// - Faz autenticação com JWT (login)
// - Protege rotas com middleware (auth)
// - Controla CRUD de pizzas, clientes, pedidos e usuários
// - Restringe algumas rotas apenas para administradores
